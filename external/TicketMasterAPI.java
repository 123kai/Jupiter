...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "cuAWqAumRKo026CRLyAg8yb2RZdcnUAz";
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		try {
			...
			//_embeded is HashMap, make sure the key is not null 
	...
	private String getAddress(JSONObject event) throws JSONException {
		if (!event.isNull("_embedded")) {
			...
			if (!embedded.isNull("venues")) {
				...
				if (venues.length() > 0) {
					//venues is array, include many objects，each object is <key, value>    
	...
	private String getImageUrl(JSONObject event) throws JSONException {
		if (!event.isNull("images")) {
			...
			//some image objects could be null   
